---
title: 在Cloudflare Workers搭静态博客？还带后台的那种？——Cloudflare Workers Blog部署教程
date: 2021-12-18 12:19:12
...
首先你要有cf帐号和一个域名（域名可以用cf workers自带的，但是很嗨长）

然后进入后台，点Workers的KV

![](https://pic.lanta.cyou/img/2021-12-18_12-22.png)

![](https://pic.lanta.cyou/img/2021-12-18_12-23.png)
...
复制好之后新建一个Workers，名字依旧随便你

![](https://pic.lanta.cyou/img/2021-12-18_12-27.png)

![](https://pic.lanta.cyou/img/2021-12-18_12-29.png)

保存完之后退出去，点设置->变量->KV命名空间绑定

![](https://pic.lanta.cyou/img/2021-12-18_12-30.png)

变量名称必须大写的`CFBLOG`

![](https://pic.lanta.cyou/img/2021-12-18_12-31.png)

这个时候就能正常使用了，但是我们还需要配置一下清除缓存，不然文章不能及时出现（**仅限有域名的**）没域名的可以直接开耍了

## 域名（缓存）设置

首先跑去你的域名的cf设置，拉到底部，复制**区域ID**

![](https://pic.lanta.cyou/img/2021-12-18_12-34.png)

然后再点下面的**获取您的API令牌**

![](https://pic.lanta.cyou/img/2021-12-18_12-35.png)

![](https://pic.lanta.cyou/img/2021-12-18_12-36.png)

![](https://pic.lanta.cyou/img/2021-12-18_12-37.png)

回到你的Workers，输入你的区域ID和API令牌

![](https://pic.lanta.cyou/img/2021-12-18_12-38.png)

### 绑定域名

回到域名设置

![](https://pic.lanta.cyou/img/2021-12-18_12-48.png)

![](https://pic.lanta.cyou/img/2021-12-18_12-49.png)

然后我们还要让这个域名真实存在，所以我们要创建一个解析

![](https://pic.lanta.cyou/img/2021-12-18_12-51.png)

如果cf的`1.1.1.1`填进去报错的话随便来一个就行了，这里只有域名生效的作用

## 部署成功

![](https://pic.lanta.cyou/img/2021-12-18_12-53.png)

右下角有一个**管理站点**，点进去之后就可以新建文章和管理文章了

![](https://pic.lanta.cyou/img/2021-12-18_13-02.png)

![](https://pic.lanta.cyou/img/2021-12-18_13-03.png)

站点预览：http://cfwb.lantacn.xyz/

## 注意事项

记得设置分类，不设置分类是保存不了文章的
